...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    ZJDFirstViewController *fvc = [[ZJDFirstViewController alloc]init];
    ZJDSecondViewController *svc = [[ZJDSecondViewController alloc]init];
    tc = [[UITabBarController alloc] init];
    tc.viewControllers = [[NSArray alloc] initWithObjects:fvc, svc, nil];
