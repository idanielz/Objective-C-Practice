...
- (void)commonInit
{
    ...
    //((CAShapeLayer *)self.layer).fillColor  = [UIColor colorWithRed:2/255.0f green:52/255.0f blue:122/255.0f alpha:1].CGColor;
    ...
    self._selectedStainView.backgroundColor = [UIColor colorWithRed:0.816 green:0.816 blue:0.816 alpha:1];
     ...
     //self._selectedStainView.backgroundColor = [UIColor colorWithRed:2/255.0f green:30/255.0f blue:69/255.0f alpha:1];
}
